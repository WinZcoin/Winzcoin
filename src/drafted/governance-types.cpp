...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "WinzcoinNetwork") type = WinzcoinNetwork;
    if(strType == "WinzcoinNetworkVariable") type = WinzcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == WinzcoinNetwork) s = "WinzcoinNetwork";
    if(type == WinzcoinNetworkVariable) s = "WinzcoinNetworkVariable";
