 ...
 *
 *   // network
 *   CWinzcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://www.Winzcoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CWinzcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CWinzcoinNetwork(UniValue objIn)
    {
...
// // can be under: WinzcoinNetwork
// //   -- signature requirements : Key1(User)
// class CWinzcoinNetworkVariable : public CGovernanceObject
// {
// private:
